...
// clang-format off
// generated by external/sqlpp23/scripts/sqlpp23-ddl2cpp --path-to-ddl schema/qwparity_schema.sql --namespace moller::db::schema --path-to-header include/mollerdb/schema/qwparity_schema.h --path-to-custom-types schema/custom_types.csv
